...
if __name__ == "__main__":
    # check(language = "Chinese", gold_path=r'NER/Chinese/validation.txt', my_path="C1.txt")
    check(language = "Chinese", gold_path=r'C:\Users\84663\Desktop\chinese_test.txt', my_path="test31.txt")
    # check(language="English", gold_path=r'C:\Users\84663\Desktop\english_test.txt', my_path="test32_15.txt")