...
if __name__=='__main__':
    with open('word_to_ix_E.txt', 'r', encoding='utf-8') as f:
        word_to_ix = f.read()
        word_to_ix = json.loads(word_to_ix)

    ix_to_tag = {}
    for num in range(len(label_E)):
        ix_to_tag[num] = label_E[num]

    ix_to_tag[9] = START_TAG
    ix_to_tag[10] = STOP_TAG

    model = torch.load("BiLSTM_CRF_E_15.joblib")
    print(model)
    loader = load.DataLoad()
    # valid_data = loader.load2('./Project2/NER/Chinese/validation.txt')
    valid_data = loader.load2_E(r'C:\Users\84663\Desktop\english_test.txt')
    # print(valid_data[0:2])
    print('================================================================')
    valid_data2 = loader.load_E(r'C:\Users\84663\Desktop\english_test.txt')  # 用于制作txt文件
    ...
    with open('test32_15.txt', 'w', encoding="utf-8") as f:
