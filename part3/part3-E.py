...
if __name__ == '__main__':
    ...
    training_data = loader.load2('NER/English/train.txt')
    # print(training_data)
    # training_data = np.array(training_data)
    # print(training_data[0])
    # # a_target = le.fit_transform(a_data)
    # le = preprocessing.LabelEncoder()
    # training_data = le.fit_transform(training_data)
    ...
    with open('word_to_ix_E.txt', 'w', encoding='utf-8') as f:
    ...
    # model = torch.nn.DataParallel(model, device_ids=gpus).cuda()   #将模型转为cuda类型
    ...
    # import joblib
    # joblib.dump(model, "BiLSTM_CRF.pkl")
    torch.save(model, "this1.joblib")
