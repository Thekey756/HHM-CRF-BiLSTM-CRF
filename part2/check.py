...
if __name__ == "__main__":
    check(language="Chinese", gold_path=r'NER/Chinese/validation.txt', my_path="part2.txt")
    # check(language = "Chinese", gold_path=r'C:\Users\84663\Desktop\chinese_test.txt', my_path="test21.txt")
    # check(language="English", gold_path=r'C:\Users\84663\Desktop\english_test.txt', my_path="test22.txt")