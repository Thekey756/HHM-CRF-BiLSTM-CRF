...
if __name__=='__main__':
    ...
    train=load_data('NER/Chinese/train.txt')
    valid=load_data('NER/Chinese/validation.txt')
    print(train)
    ...
    # 训练模型
    crf_model = sklearn_crfsuite.CRF(algorithm='lbfgs',c1=0.25,c2=0.018,max_iterations=500,
    ...
    # 保存模型
    import joblib
    joblib.dump(crf_model, "crf_model2_500.joblib")
    print(y_dev)
    print(y_pred)
